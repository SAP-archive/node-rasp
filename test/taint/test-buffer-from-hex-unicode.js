...
const buf01 = Buffer.from(strHexUnicodeTaint, 'hex');
...
const buf02 = Buffer.from(strHexUnicode, 'hex');
...
const buf03 = Buffer.from(strHexUnicode + strHexUnicodeTaint +
                                          strHexUnicode, 'hex');
...
const buf04 = Buffer.from(strHexUnicode + strHexUnicodeTaint +
...
const buf06 = Buffer.from(strHexUnicodeTaint + strHexUnicode, 'hex');
taintStart = 0;
...
const buf07 = Buffer.from(strHexUnicode + strHexUnicodeTaint, 'hex');
taintStart = bufHexUnicodeLen;
taintEnd = taintStart + bufHexUnicodeTaintLen;
...
const buf08 = Buffer.from(strHexUnicodeTaint + strHexUnicode +
