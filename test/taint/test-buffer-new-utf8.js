...
const buf01 = new Buffer(strUtf8Taint, 'utf8');
...
const buf02 = new Buffer(strUtf8, 'utf8');
...
const buf03 = new Buffer(strUtf8 + strUtf8Taint + strUtf8, 'utf8');
...
const buf04 = new Buffer(strUtf8 + strUtf8Taint + strUtf8Taint +
                                                  strUtf8, 'utf8');
taintStart = bufUtf8Len;
...
const buf05 = new Buffer(strUtf8 + strUtf8Taint.setTaint('different') +
...
const buf06 = new Buffer(strUtf8Taint + strUtf8, 'utf8');
taintStart = 0;
...
const buf07 = new Buffer(strUtf8 + strUtf8Taint, 'utf8');
taintStart = bufUtf8Len;
taintEnd = taintStart + bufUtf8TaintLen;
...
const buf08 = new Buffer(strUtf8Taint + strUtf8 + strUtf8Taint, 'utf8');
taintStart = 0;
taintEnd = bufUtf8TaintLen;
