...
const buf01 = Buffer.from(strHexTaint, 'hex');
...
const buf02 = Buffer.from(strHex, 'hex');
...
const buf03 = Buffer.from(strHex + strHexTaint + strHex, 'hex');
...
const buf04 = Buffer.from(strHex + strHexTaint + strHexTaint +
                                                strHex, 'hex');
taintStart = bufHexLen;
...
const buf06 = Buffer.from(strHexTaint + strHex, 'hex');
taintStart = 0;
...
const buf07 = Buffer.from(strHex + strHexTaint, 'hex');
taintStart = bufHexLen;
taintEnd = taintStart + bufHexTaintLen;
...
const buf08 = Buffer.from(strHexTaint + strHex + strHexTaint, 'hex');
taintStart = 0;
taintEnd = bufHexTaintLen;
