...
const buf01 = Buffer.from(strUtf16Taint, 'utf16le');
...
const buf02 = Buffer.from(strUtf16, 'utf16le');
...
const buf03 = Buffer.from(strUtf16 + strUtf16Taint + strUtf16, 'utf16le');
...
const buf04 = Buffer.from(strUtf16 + strUtf16Taint + strUtf16Taint +
                                                  strUtf16, 'utf16le');
taintStart = bufUtf16Len;
...
const buf05 = Buffer.from(strUtf16 + strUtf16Taint.setTaint('different') +
...
const buf06 = Buffer.from(strUtf16Taint + strUtf16, 'utf16le');
taintStart = 0;
...
const buf07 = Buffer.from(strUtf16 + strUtf16Taint, 'utf16le');
taintStart = bufUtf16Len;
taintEnd = taintStart + bufUtf16TaintLen;
...
const buf08 = Buffer.from(strUtf16Taint + strUtf16 + strUtf16Taint, 'utf16le');
taintStart = 0;
taintEnd = bufUtf16TaintLen;
